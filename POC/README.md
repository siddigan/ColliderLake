# ColliderLake 1.0 POC

This folder preserves the original ColliderLake proof of concept. Run legacy
commands from `ColliderLake/POC`; the existing script bootstrap and path helpers
resolve this folder as their project root, so generated files stay under
`POC/data` and `POC/outputs`.

The ColliderLake 2.0 implementation now lives at the repository root.

# Original ColliderLake README
